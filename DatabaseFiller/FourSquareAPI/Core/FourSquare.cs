...
namespace FourSquareAPI.Core
{
    public class FourSquare
    {
        ...
        {
            return RequestAsync(url, httpMethod, null);
        }

        private string RequestAsync(string url, HttpMethod httpMethod, string data)
        {
            ...
            if (data != null)
            {
                ...
                Stream stream = httpWebRequest.GetRequestStreamAsync().Result;
