...
namespace DatabaseTest
{
    ...
    public class DB_APITest
    {
        ...
        public void UpdateUserTest()
        {
            ...
            user = user.UpdateUser(login: "user111", password: "user111", name: "user111", surname: "user111", age: 20, tags: "tag");
            ...
            user = user.UpdateUser(login: "user1", password: "user1", name: "user1", surname: "user1");
